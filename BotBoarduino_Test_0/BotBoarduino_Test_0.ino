...
void loop(void)
{
    ...
    if (!g_fLowVoltageShutdown) {
        ...
        //---------------------------------------------------------------------
        int ch;
        if (ch = DBGSerial.available()) {
            ch = DBGSerial.read();
            
            g_InControlState.fHexOn = 1;
            switch (ch) {
                case 'q':
                    g_InControlState.TravelLength.x += 5;
                    DBGSerial.println("TL x: " + String(g_InControlState.TravelLength.x));
                    break;
                case 'a':
                ...
                case 'w':
                    ...
                    DBGSerial.println("TL y: " + String(g_InControlState.TravelLength.y));
                    break;
                case 's':
                ...
                case 'y':
                    ...
                    break;
                case 'e':
                    g_InControlState.TravelLength.z += 5;
                    DBGSerial.println("TL z: " + String(g_InControlState.TravelLength.z));
                    break;
                case 'd':
                ...
                case 'r':
                    g_InControlState.BodyPos.x += 5;
                    DBGSerial.println("BP x: " + String(g_InControlState.BodyPos.x));
                    break;
                case 'f':
                    g_InControlState.BodyPos.x = 0;
                    DBGSerial.println("BP x: " + String(g_InControlState.BodyPos.x));
                ...
                case 'c':
                    ...
                    break;
                case 't':
                    g_InControlState.BodyPos.y += 5;
                    DBGSerial.println("BP y: " + String(g_InControlState.BodyPos.y));
                    break;
                case 'g':
                    g_InControlState.BodyPos.y = 40;
                    DBGSerial.println("BP y: " + String(g_InControlState.BodyPos.y));
                ...
                case 'v':
                    ...
                    break;
                case 'z':
                    g_InControlState.BodyPos.z += 5;
                    DBGSerial.println("BP z: " + String(g_InControlState.BodyPos.z));
                    break;
                case 'h':
                    g_InControlState.BodyPos.z = 0;
                    DBGSerial.println("BP z: " + String(g_InControlState.BodyPos.z));
                ...
                case 'u':
                    g_InControlState.BodyRot1.x += 5;
                    DBGSerial.println("BR x: " + String(g_InControlState.BodyRot1.x));
                    break;
                case 'j':
                    g_InControlState.BodyRot1.x = 0;
                    DBGSerial.println("BR x: " + String(g_InControlState.BodyRot1.x));
                ...
                case 'n':
                    ...
                    break;
                case 'i':
                    g_InControlState.BodyRot1.y += 5;
                    DBGSerial.println("BR y: " + String(g_InControlState.BodyRot1.y));
                    break;
                case 'k':
                    g_InControlState.BodyRot1.y = 40;
                    DBGSerial.println("BR y: " + String(g_InControlState.BodyRot1.y));
                    break;
                case 'm':
                    g_InControlState.BodyRot1.y -= 5;
                    ...
                    break;
                case 'o':
                    g_InControlState.BodyRot1.z += 5;
                    DBGSerial.println("BR z: " + String(g_InControlState.BodyRot1.z));
                    break;
                case 'l':
                    g_InControlState.BodyRot1.z = 0;
                    DBGSerial.println("BR z: " + String(g_InControlState.BodyRot1.z));
                ...
                case 'p':
                    g_InControlState.LegLiftHeight += 5;
                    DBGSerial.println("LLH: " + String(g_InControlState.LegLiftHeight));
                    break;
                case '-':
                    g_InControlState.LegLiftHeight = 20;
                    DBGSerial.println("LLH: " + String(g_InControlState.LegLiftHeight));

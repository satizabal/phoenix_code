...
import champ2011client.CarController.Stage;
...
public class Client {
    ...
    public static void main(String[] args) {
        ...
        CarController driver = load(args[0]);
    ...
    private static CarController load(String name) {
        CarController controller=null;
        try {
            controller = (CarController) (Object) Class.forName(name).newInstance();
        }
